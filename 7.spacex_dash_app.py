...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(site_data, names='class', title=f'Total Success Launches for {entered_site}')
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        site_data = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(site_data, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Correlation between Payload and Success for {entered_site}')
        return fig
